...
const translateLines = () => {
    ...
    if (line1.className === 'line-1') {
        line1.className = 'line-1t';
    }
    else {
        line1.className = 'line-1';
    }

    if (line2.className === 'line-2') {
        line2.className = 'line-2t';
    }
    else {
        line2.className = 'line-2';
    }

    if (line3.className === 'line-3') {
        line3.className = 'line-3t';
    }
    else {
